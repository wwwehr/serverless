...
module.exports = {
  extendedValidate() {
    ...
    this.serverless.service.package.deploymentDirectoryPrefix =
      state.package.deploymentDirectoryPrefix;
    this.serverless.service.package.timestamp = state.package.timestamp;
    this.serverless.service.package.artifactsMap = state.package.artifactsMap;
