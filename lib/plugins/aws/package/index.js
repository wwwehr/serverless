...
const generatePackageRuntimeMetadata = require('./lib/generatePackageRuntimeMetadata');
...
class AwsPackage {
  constructor(serverless, options) {
    ...
    this.hooks = {
      ...
      'before:package:compileFunctions': async () => this.generatePackageRuntimeMetadata(),

      'before:package:compileLayers': async () => this.generatePackageRuntimeMetadata(),
